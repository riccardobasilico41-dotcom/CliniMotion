...
const PAESI: Paese[] = [messico]
const DESTINAZIONI: Destinazione[] = [...destinazioniMessico]
const ESPERIENZE: Esperienza[] = [...esperienzeMessico]
const TRIP_META: TripMeta[] = [messicoBeachLifeMeta]

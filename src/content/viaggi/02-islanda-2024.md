...
- **Quando andare:** estate — clima comunque variabile, tra 10 e 20°C di giorno,
  possibili 0°C e umidità la notte.
...
- **Reynisfjara** — spiaggia di sabbia nera, bellissima ma da rispettare per la
  sicurezza.
- **Jökulsárlón e Diamond Beach** — la laguna glaciale con le foche e gli
  iceberg, e la spiaggia dove si arenano sulla sabbia nera.
- **Stuðlagil Canyon** — chicca meno battuta, colonne di basalto e acqua
  turchese.
- **Zona di Mývatn** — concentrato di fenomeni geotermici e vulcanici in poche ore
  di visita (Hverir, Dimmuborgir, Grjótagjá, Goðafoss).
- **Dettifoss** — la cascata più potente d'Europa, impressionante anche solo per
  il boato.
- **Kirkjufell** — la montagna più fotografata d'Islanda, ottima al tramonto.
- **Vök Baths** — piscina termale galleggiante vicino Egilsstaðir, ottima pausa
  a metà viaggio.
- **Whale watching a Húsavík** — la "capitale mondiale" dell'avvistamento
...
- **Intimo termico**, giacca a vento impermeabile con cappuccio (no ombrelli, il
  vento è troppo forte), scarpe da trekking + un paio di riserva.
- **Costume da bagno non nuovo/prezioso**: le acque geotermali della Blue Lagoon
  rovinano i tessuti se non sciacquati subito.
...
Fonti caricate:
1. **Islanda_Expedition_2023** (itinerario orario) — copre Giorno 1, 2 e parte del
   Giorno 3 (fino al pranzo a Reynisfjara), poi le righe della tabella sono vuote.
2. **ISLANDA_VADE_MECUM** (schede sui luoghi) — copre dal Giorno 2 al Giorno 6/7
   con approfondimenti su geologia, leggende e curiosità di ogni tappa, ma senza
   orari/logistica.
3. **ISLANDA_EXPEDITION — baggage** — checklist bagaglio e regole di gruppo,
   integrata sopra.
4. **Correzione personale confermata**: il relitto dell'aereo a Sólheimasandur
   non è stato visitato la mattina del Giorno 3 come da programma originale,
   ma **a piedi, a mezzanotte**, dopo cena del Giorno 2 — grazie al sole di
   mezzanotte ancora presente a inizio luglio. Spostato nel file di conseguenza.
5. **Traccia di riferimento con orari** — i Giorni 3 (pomeriggio) → 9 sono stati
   ricostruiti con lo stesso livello di dettaglio dei Giorni 1-3, incrociando
   l'ordine dei luoghi del vademecum con un itinerario di riferimento dello
   stesso percorso (Ring Road in tenda, 9 giorni da Keflavík a Keflavík), tempi
   di guida reali tra le tappe (fonti stradali/turistiche islandesi) e i
   campeggi realmente presenti in ogni zona (Vestrahorn/Höfn, Camp Egilsstaðir,
   Ásbyrgi, Hamrar/Akureyri, Grundarfjörður/Kirkjufell). Gli orari sono stime
   plausibili basate su tempi di percorrenza reali, non il vostro diario
   originale: **da confermare o correggere con foto, ricevute o ricordi
...
- [ ] foto a Reynisfjara
- [ ] foto della laguna di Jökulsárlón con gli iceberg
- [ ] foto della vita in campeggio/tenda
- [ ] foto allo Stuðlagil Canyon e a Dettifoss
- [ ] foto alla zona geotermale di Hverir/Dimmuborgir
- [ ] foto al Kirkjufell

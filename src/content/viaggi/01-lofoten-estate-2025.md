...
### Giorno 1 — Oslo
Atterraggio a Gardermoen verso l'ora di pranzo. Dall'aeroporto il treno **Flytoget**
porta al centro in 19 minuti (~210 NOK, partenze ogni 10 min, si segue "Flytoget
Airport Express" dentro il terminal). Da Oslo S l'hotel (Citybox Hotel) è a 5 minuti
a piedi.

Pomeriggio a piedi: giardini del Palazzo Reale → lungomare di Aker Brygge → museo
...
del villaggio, piccolo ma vivace tra bakery, artigianato locale e boutique vintage.

Nel pomeriggio **Festvågtind trail** (parcheggio al Festvågtind Parking): 3 km per
500 m di dislivello, più tecnico del Reinebringen — tratti rocciosi e terreno
sabbioso/irregolare. In circa 40 minuti si arriva a un punto panoramico intermedio
...
fino a una casetta bianca fotogenica, poi salita leggera che costeggia un piccolo
cimitero (15 min) fino a un colle panoramico, seguita da 5 minuti di discesa verso
...
Nel pomeriggio, appena il cielo si è aperto, passeggiata panoramica da **Nesland
verso Nusfjord**: ~11 km A/R lungo il fiordo, tra bosco e tratti rocciosi, senza
difficoltà tecniche — ottima alternativa più leggera dopo i trekking dei giorni
precedenti. Cena casalinga nella rorbu (pasta panna e salmone, per finire le scorte
della grigliata).
...
precedenti) e traghetto verso **Misten/Kjerringøy** (~10 min, si resta in auto,
arrivare 30 min prima). Kjerringøy non ha entusiasmato particolarmente, ma è
...
- **Reinebringen** — il trekking simbolo delle Lofoten, 1.978 scalini, vista top solo
  con cielo sereno.
- **Trollfjord in RIB** con Lofoten Explorer — aquile di mare a pochi metri dalla barca.
- **Festvågtind trail** — più tecnico e "selvaggio" del Reinebringen.
- **Spiaggia di Bunes** — raggiungibile solo via traghetto per Vindstad, tra le più
  suggestive.
- **Villaggio di Å** + Museo dei Pescatori — la Lofoten "storica" e autentica.
- **Henningsvær** — il campo da calcio più fotografato della Norvegia e un'atmosfera
  bohémien.
- **Chicca poco turistica:** la passeggiata Nesland–Nusfjord, panoramica e senza le
...
- Bodø: Bryggerikaia, Melkebaren
- Svolvær: Bacalo, **Paleo Arctic** (il migliore del viaggio)
- Henningsvær: Fiskekrogen
- Leknes: DIGG Restaurant
- Ramberg: Ramberg Resort
- Sakrisøy: Anita's Seafood

## Consigli pratici / errori da non ripetere
- Prenotare per tempo l'escursione al Trollfjord: è l'esperienza top del viaggio.
- Portare strati pesanti anche a luglio: il vento sulle spiagge e sui crinali si fa
  sentire.
- Guanti/sottoguanti utili per la gita in gommone.
- Arrivare sempre con 30-40 minuti di anticipo ai traghetti, anche con posto
  riservato.
- Il Reinebringen richiede un minimo di allenamento per via del dislivello; se il
  cielo è coperto, meglio rimandarlo — la vista è tutto.
- Portare contanti NOK/EUR per i piccoli locali che non accettano carta (es. Kate
  Koisk Husflid).
- Il supermercato di Ramberg è più fornito e conveniente di quello di Reine, ma
...
- [ ] foto dalla cima del Reinebringen
- [ ] foto della spiaggia di Bunes
- [ ] foto del campo da calcio di Henningsvær
- [ ] mappa dell'itinerario complessivo (Oslo → Bodø → Svolvær → Reine/Nesland → Å)

## Tag
`#norvegia` `#lofoten` `#on-the-road` `#estate-polare` `#trekking`

...
### Un viaggio fatto (soprattutto) di strada
Più che negli altri viaggi di questo archivio, qui il tempo passato in auto è parte integrante dell'esperienza: si parla di **5 ore di guida in un solo giorno** (Day 3, Brașov-Sighișoara-Salina Turda-Sibiu) e di un altro tratto di **3h45 non-stop** nel pomeriggio del Day 4 per rientrare a Bucarest dopo la Transfăgărășan. Le strade di montagna sono strette, piene di tornanti e — sui passi più alti — spesso chiuse o percorribili solo in parte a seconda della stagione: la Transfăgărășan stessa è aperta di norma solo dal 20 giugno al 31 ottobre, altrimenti si sale solo in funivia fino al Lago Bâlea.

**Un punto da tenere bene a mente prima di mettersi al volante:** la Romania è, da diversi anni consecutivi, il Paese con il più alto tasso di mortalità stradale dell'Unione Europea — 78 morti per milione di abitanti nel 2024 secondo i dati Eurostat/Commissione Europea, contro una media UE di 44 (le strade più sicure sono in Svezia, con appena 20). Non è quindi un caso isolato o una percezione: i numeri lo confermano, ed è per questo che l'itinerario stesso invita più volte a **rispettare le tempistiche, non guidare di fretta e monitorare sempre il meteo**, soprattutto sui passi di montagna dove le condizioni possono cambiare rapidamente e la visibilità nei tornanti è spesso limitata. Qualche accorgimento pratico, oltre alla prudenza di base:
- Sulla Transfăgărășan e sulla strada del ritorno verso Bucarest è frequente avvistare **orsi** ai bordi della carreggiata: non dare loro da mangiare e non scendere dall'auto, ci si limita a fotografare dal finestrino.
- Le strade di montagna possono chiudere improvvisamente per meteo: controllare sempre il sito ufficiale prima di partire e avere un piano B (in questo itinerario, la deviazione verso una delle cittadelle sassoni se il passo è chiuso).
- I lunghi tratti di guida vanno spezzati con soste regolari, soprattutto nei giorni con più ore al volante: meglio partire presto e avere margine, piuttosto che rincorrere gli orari.
...
Al mattino, possibile tappa al **Bear Sanctuary** (da valutare, biglietti online entro 14 giorni prima, tour guidato): gli orsi sono attivi solo di mattina, quindi va fatta come prima cosa della giornata; per i turni con la Transfăgărășan aperta, si consiglia di saltarla, dato che si vedranno comunque orsi lungo la strada del Day 4.

Transfer verso **Viscri** (1h20, tappa facoltativa da valutare in base ai tempi): uno dei due principali villaggi sassoni della Transilvania, con la sua **Chiesa Fortificata** del XII secolo, Patrimonio UNESCO (12 LEI/pax).
...
- Il **Castello di Peleș**, forse il più bello architettonicamente di tutto il viaggio.
- Le **saline sotterranee di Salina Turda**, con il laghetto navigabile e i giochi alla base.
- La **Transfăgărășan**, la strada panoramica per eccellenza della Romania.
- Il centro storico UNESCO di **Sighișoara**, con la casa natale del Conte Dracula.
...
- **Brașov:** Sergiana, Casa Românească
- **Sighișoara:** Gasthaus Altepost, Vlad Dracul Restaurant
- **Sibiu:** Crama Sibiul Vechi, La Dobrun, Crama Ileana
...
1. **Transilvania Express** — foglio operativo sintetico con orari, contatti locali (autisti, guide, ristoranti) e budget di cassa comune per attività specifiche, giorno per giorno.
2. **Diario di Viaggio Transilvania Express** — documento discorsivo completo per il coordinatore, con approfondimenti su ogni tappa, alternative in caso di maltempo, indicazioni su guide e prenotazioni, opzioni di cena/dopocena.
3. **Vade Mecum Transilvania Express** — informazioni pratiche generali: contatti dell'Ambasciata d'Italia a Bucarest, documenti/visto, clima, cambio moneta, assicurazione, bagaglio, medicinali, vestiario, regole della cassa comune (90€ a persona, ritirata in contanti in lei al meeting di benvenuto).
4. **Statistiche di sicurezza stradale UE** (Eurostat/Commissione Europea, dati 2024) — usate per contestualizzare il tema "strade belle ma impegnative" richiesto esplicitamente per questo viaggio.
...
- [ ] foto del Castello di Bran/Dracula
- [ ] foto della Fortezza di Râșnov con la scritta "Brașov" sullo sfondo
- [ ] foto delle saline di Salina Turda e del laghetto sotterraneo
- [ ] foto della Transfăgărășan e del Lago Bâlea
- [ ] foto di eventuali orsi avvistati dall'auto (in sicurezza, dal finestrino)
- [ ] mappa del percorso ad anello (Bucarest → Sinaia/Peleș → Bran → Brașov → Sighișoara → Salina Turda → Sibiu → Transfăgărășan → Bucarest)

## Tag
`#romania` `#transilvania` `#roadtrip` `#dracula` `#transfagarasan` `#castelli` `#europa`

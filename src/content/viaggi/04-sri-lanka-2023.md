...
- **Sim/dati:** meglio comprare la SIM locale (Dialog o SLT Mobitel) subito dopo
  il controllo passaporti in aeroporto — costa molto meno che nel desk prima dei
  controlli.
- **Da mettere in valigia senza sbagliare:** pantaloni lunghi o un pareo (per
  coprire le ginocchia nei templi), calzini (nei templi si cammina scalzi, il
  pavimento può scottare), una felpa per la cima gelida dell'Adam's Peak (3-6°C
...
- **Tuk tuk a noleggio, self-drive**: si guida da soli per tutta l'isola.
  Serve un permesso di guida locale temporaneo (circa 30-40$, la società di
  noleggio lo organizza) più un permesso internazionale di guida dal proprio
  paese. Le aziende più affidabili (es. **Holiday Tuk Tuk**,
  holidaytuktuk.com, con base a Kandy) danno una lezione di guida completa
  prima della partenza e assistenza 24/7 lungo il percorso. È il modo più
  autentico e divertente di vedere il paese, ma richiede di sapersela cavare
  nel traffico caotico delle città e sulle strade di montagna (alcune aziende
  offrono anche una lezione specifica per i tornanti verso Ella).
- **Bus locali, i cosiddetti "chicken bus"**: in Sri Lanka non esistono
  pullman a lunga percorrenza come altrove in Asia, solo bus pubblici locali —
  i rossi della compagnia statale **SLTB** e i blu delle compagnie private.
  Il soprannome "chicken bus" (mutuato dal Centro America, ma usato spesso
  anche dai viaggiatori qui) descrive bene l'esperienza: mezzi affollati,
  colorati, a volte con animali a bordo, cartelli di destinazione che i
  conducenti dimenticano di cambiare. È il modo più economico ed
  esperienziale di spostarsi, ma richiede di chiedere sempre conferma della
  destinazione all'autista o ai passeggeri. Le informazioni aggiornate su
  orari e stazioni si trovano meglio chiedendo direttamente alle stazioni dei
  bus (la più grande è il Central Bus Stand di Pettah, a Colombo) o all'hotel;
  online, siti come Rome2Rio danno un'idea delle tratte, ma gli orari reali
  vanno sempre verificati sul posto. Per i treni invece (come la tratta
  panoramica Nanu Oya-Ella) i biglietti vanno prenotati con largo anticipo:
  vanno a ruba e in alta stagione c'è un vero mercato nero dei posti a sedere.
...
italiana di sottofondo — circa 12€ a testa). Dopocena al **Rodeo** o allo **Sky
Lounge**, oppure a caccia di un beach party chiedendo a guida e locali.
*Consiglio per il giorno dopo: il fish market di Negombo la mattina presto è
...
singalese: dagoba immense, alberi sacri (il Sri Maha Bodhi, discendente diretto
dell'albero sotto cui il Buddha raggiunse l'illuminazione) e rovine che
...
- **Visita a Polonnaruwa** (circa 2h30-3h): noleggio biciclette in loco (1.000
  ...
  rispetto a Sigiriya. Guida consigliata: Indu (6.000 LKR + mancia).
- Pranzo (prima o dopo la visita a seconda dei tempi) al **Priyamali gedara**,
  ristorante di campagna con vista sulle risaie — molto buono.
- Rientro verso Dambulla con sosta per un **massaggio ayurvedico** (da
  prenotare il giorno prima tramite l'autista).
...
- **Trasferimento a Kitulgala** (circa 2h): giornata dedicata agli sport
  ...
  *Il ponte sul fiume Kwai*) organizzato dal DMC locale. Possibile
  combinazione con canyoning, tuffi in cascata e una camminata nella giungla
  con pranzo, da concordare con l'operatore.
- Arrivo in serata ad **Hatton/Nallathanniya**, base per la scalata
  dell'**Adam's Peak** della notte stessa o della successiva.
- **Cena** in hotel.
...
- Arrivo a **Nuwara Eliya**, la "piccola Inghilterra" di Sri Lanka, a 1.868 m
  ...
  - **Relax**: massaggio, cerimonia del tè al Grand Hotel, Victoria Park,
    cascate di Ravana o dei Lover's Leap (attività piuttosto costose, sui
    5.000-8.000 LKR).
  - **Avventura**: trasferimento all'**Horton Plains National Park** (1h) e
    trekking a **World's End** (3h), il ciglio di un altopiano che precipita
    per 870 metri a strapiombo — tra i panorami più spettacolari dell'isola.
- **Cena** a Nuwara Eliya, tra **De Silva Food Center**, **Grand Indian**,
  **Grand Thai** o **Themparadu** (quest'ultimo il più locale). Dopocena al
  **Lakeview Pub**.
...
- **Arrivo a Mirissa** nel primo pomeriggio: pranzo veloce (pizza buona da un
  chiosco locale, circa 4.000 LKR) prima di proseguire.
- **Arrivo a Hikkaduwa** nel tardo pomeriggio, check-in in hotel.
- **Cena** in spiaggia — servizio lento ma cena ottima (provato il red
  snapper), da un ristorante con vista sul mare.

### Giorno 10 — Hikkaduwa: giornata di mare
Giornata libera interamente dedicata alla spiaggia. Tra le opzioni:
- **Nuoto con le tartarughe**: il miglior punto è davanti all'Hikka Tranz by
  Cinnamon Hotel.
- **Tsunami Museum**, per capire l'impatto dello tsunami del 2004 su questa
  costa.
- **Big Buddha**, surf, snorkeling, diving, boat safari sul fiume Madu.
- In caso di maltempo: possibile visita a Colombo.
- Pranzo consigliato in spiaggia da **Steffi's Mandala** (vegetariano) o
  **Thambili Cafe**.
- **Cena**: **Sea Salt Society** (beach club) o **Canal View**.

### Giorno 11 — Hikkaduwa-Negombo
Ultima mattinata libera a Hikkaduwa, con possibile tappa al **Sea Turtle
Conservation Project di Bentota** (45 min) lungo il tragitto di rientro verso
Negombo. Possibile visita pomeridiana a Colombo se il tempo lo consente.

**Cena di addio** (non inclusa), stessi indirizzi del Giorno 1 (Salt
Restaurant, Tuk Tuk Wine & Dine, Jude Restaurant). Dopocena come al Giorno 1,
con eventuale beach party finale.

### Giorno 12 — Negombo-Aeroporto
Check-out e transfer in aeroporto (con Michael, circa 5.000 LKR a macchina).
Nessun servizio organizzato per la giornata: tempo libero fino al volo di
rientro.

## Cosa vedere / cosa fare
- **Sigiriya** — la Rocca del Leone, tra le rovine reali più spettacolari
  dell'Asia.
- **Adam's Peak di notte** — la vera sfida fisica del viaggio, tra pellegrini
  locali e alba in cima.
- **Safari a Minneriya e Yala** — elefanti nel primo caso, leopardi (con un
  po' di fortuna) nel secondo.
- **Il Tempio del Dente a Kandy** — cerimonia serale, tamburi, atmosfera
  spirituale unica.
- **Il treno panoramico Nuwara Eliya-Ella** — imperdibile nonostante i
  ritardi, tra piantagioni di tè e vallate verdissime.
- **Pidurangala Rock al tramonto** — la vista su Sigiriya che tutti si
  perdono per correre a fare la Rocca stessa.
- **Le spiagge del sud** — Mirissa e Hikkaduwa, il contrappunto rilassato dopo
...
| 12-13 nov | Anuradhapura | Miridiya Lake Resort |
| 13-15 nov | Dambulla | Tropical Life Resort |
| 15-16 nov | Kandy | Rivendell Hotel |
| 16-17 nov | Nallathanniya | Wathsala Inn |
| 17-18 nov | Nuwara Eliya | Araliya RED |
...
- Negombo: Jude Restaurant (pesce buono ma lento, 12€/pax); SeaJoy (pranzo
  economico)
- Anuradhapura: buffet in hotel
- Dambulla/Sigiriya: Mom's Kitchen, Golden Palace
- Polonnaruwa: Priyamali gedara (ottimo, vista risaie)
- Kandy: Ranweli Spice Garden (pranzo), ristorante indiano del sud scovato sul
  posto (economico e ottimo)
- Nuwara Eliya: De Silva Food Center, Grand Thai/Grand Indian, Themparadu
- Ella: cooking class del DMC, dopocena al One Love Ella
- Hikkaduwa: cena in spiaggia (red snapper), Steffi's Mandala, Sea Salt Society

## Consigli pratici / cosa mettere in valigia
- **Prenotare il treno panoramico con largo anticipo**: i biglietti vanno a
  ruba, soprattutto in alta stagione.
- **Mettere in conto ritardi**: sia sui treni sia sui trasferimenti via terra
  — lo Sri Lanka non è un paese dove il programma va sempre secondo i piani.
- **Sarong sempre a portata di mano**: serve in quasi tutti i templi (Mihintale,
  Sigiriya, Dambulla, Tooth Temple).
- **Contanti in LKR**: molti ristoranti locali e piccoli operatori non
  accettano carte.
- **Diffidare dei "pescatori su palafitta"**: lungo la costa sud sono ormai
  quasi sempre una messa in scena a pagamento per turisti.
- **Massaggi ayurvedici**: da prenotare con un giorno d'anticipo tramite
  l'autista o l'hotel.
...
Fonti caricate:
1. **Service Confirmation Voucher (WanderlustAsia)** — conferma ufficiale di
   hotel, date (11-22 novembre 2023), transfer e attività incluse.
2. **Sri Lanka 360 - Itinerario 11/11-22/11 (WeRoad)** — programma giorno per
   giorno con orari, indirizzi e contatti.
3. **Versione con appunti a penna** — la fonte più preziosa: contiene i tempi
   e i prezzi *realmente* verificati sul posto (spesso diversi da quelli
   programmati), voti ai ristoranti, correzioni al programma (es. Polonnaruwa
   visitato prima a pranzo poi al sito, tappa non pianificata a un
   orfanotrofio, trasferimento Pedro Tea Plantation molto più breve del
   previsto). Integrata nel file ovunque disponibile.
4. **SRL_Diario di viaggio 3.0** — documento operativo per il coordinatore
   (in inglese), con dettagli aggiuntivi su Adam's Peak, safari, logistica
...
## Foto/media
- [ ] foto di Sigiriya dall'alto e da Pidurangala Rock
- [ ] foto della salita notturna all'Adam's Peak e dell'alba in cima
- [ ] foto del safari (elefanti a Minneriya, eventuali leopardi a Yala)
- [ ] foto del Tempio del Dente durante la cerimonia serale
- [ ] foto del treno panoramico tra le piantagioni di tè
- [ ] foto delle spiagge di Mirissa e Hikkaduwa
- [ ] mappa del percorso ad anello (Negombo → triangolo culturale → montagne
  del tè → sud → Negombo)

## Tag
`#srilanka` `#adamspeak` `#sigiriya` `#safari` `#trenopanoramico` `#asia`

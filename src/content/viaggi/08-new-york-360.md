...
- **Dopocena** al Magic Hour Bar.
- **Hotel:** Paramount Hotel, 235 W 46th St.
...
- **The Oculus**.
- Pranzo da **Pisillo** (panini).
- **DUMBO** (Brooklyn): l'incrocio tra Water Street e Washington Street (la foto simbolo con il ponte di Manhattan sullo sfondo), la giostra storica **Jane's Carousel**, il **Brooklyn Flea Market** (solo la domenica), l'arco del ponte di Manhattan, **Brooklyn Bridge Park** e la traversata a piedi del **Brooklyn Bridge**.
- **Cibo**: Vinegar Hill House, Bluestone Lane (caffetteria a Dumbo).
- **Tempo libero**: New York Public Library, Quinta Avenue, Macy's, Hotel Plaza, Trump Tower, Rockefeller Center.
- **Tramonto** al **Top of the Rock**.
- **Cena e serata**: Virgil's BBQ, poi 230 Rooftop, con giro finale in limo a Times Square.

### Giorno 6 (12.09) — Rientro
Check-out e saluti.

## Sport dal vivo: una partita di baseball e una di basket
Settembre è il periodo perfetto per unire due sport diversi in un solo viaggio:
- **Baseball**: settembre è piena corsa verso i playoff MLB, con partite cariche di tensione — sia i **New York Yankees** (Yankee Stadium, nel Bronx, raggiungibile con la metro linea 4) sia i **New York Mets** (Citi Field, nel Queens, linea 7) giocano in casa regolarmente in questo periodo. Un'esperienza molto americana di per sé: hot dog, birra, settima inning stretch (la pausa canora a metà partita), atmosfera da stadio tutta diversa da quella europea.
- **Basket**: la stagione NBA (Knicks e Nets) inizia solo a ottobre, quindi a settembre l'unica opzione per il basket dal vivo sono le **New York Liberty**, la squadra WNBA di New York, che gioca al **Barclays Center** di Brooklyn (lo stesso palazzetto dei Nets). Settembre è proprio il periodo dei playoff WNBA — le Liberty, campionesse in carica dal 2024, regalano un'atmosfera elettrica, biglietti generalmente più economici di una partita NBA e un pubblico molto partecipativo. Un'ottima alternativa (o aggiunta) rispetto ad aspettare la stagione NBA vera e propria.

## Cosa vedere / cosa fare — i momenti clou
- **Top of the Rock al tramonto** — vista aperta su Central Park e sull'Empire State Building, spesso preferita dai newyorkesi stessi rispetto all'Empire State come punto panoramico.
- **Statua della Libertà ed Ellis Island** — la storia dell'immigrazione raccontata da vicino.
- **DUMBO** — lo scorcio più fotografato di Brooklyn, con vista sul ponte di Manhattan.
- **Broadway** — un musical dal vivo, tappa immancabile.
- **Una partita sportiva dal vivo** — baseball (Yankees o Mets) o basket (New York Liberty), il modo più autentico per vivere la città come un newyorkese qualunque per una sera.
- **Harlem la domenica mattina** — tra messa gospel e Apollo Theater, il lato di New York meno da cartolina.
...
- Cena: Shake Shack, Kesté Pizza, Ellen's Stardust Diner, Virgil's BBQ.
...
- [ ] foto dal Top of the Rock al tramonto
- [ ] foto della Statua della Libertà
- [ ] foto di DUMBO con il ponte di Manhattan sullo sfondo
- [ ] foto della partita di baseball (Yankee Stadium o Citi Field)
- [ ] foto della partita delle New York Liberty al Barclays Center
- [ ] foto dell'Empire State Building di sera

## Tag
`#newyork` `#usa` `#broadway` `#baseball` `#basket` `#wnba` `#brooklyn`

...
export function ExperienceCard({ esperienza, paeseSlug }: { esperienza: Esperienza; paeseSlug: string }) {
  return (
    <Link
      ...
      className="group flex flex-col gap-3 rounded-2xl border border-alpine/10 bg-white p-5 transition-[box-shadow,transform] duration-150 ease-out hover:shadow-lg active:scale-[0.99] motion-reduce:active:scale-100"
    >
